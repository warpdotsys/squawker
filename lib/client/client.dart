...
class Twitter {
  ...
  static Future<bool> followUser(String userId) async {
    try {
      final uri = Uri.https('x.com', '/1.1/friendships/create.json');
      final body = 'include_profile_interstitial_type=1&include_blocking=1&include_blocked_by=1&include_followed_by=1&include_want_retweets=1&include_mute_edge=1&include_can_dm=1&include_can_media_tag=1&include_ext_is_blue_verified=1&include_ext_verified_type=1&include_ext_profile_image_shape=1&skip_status=1&user_id=$userId';
      ...
      final result = jsonDecode(response.body);
      return result['id_str'] != null;
    } catch (e) {
      Logger.root.severe('Failed to follow user: $e');
      return false;
    }
  }
  ...
  static Future<bool> unfollowUser(String userId) async {
    try {
      final uri = Uri.https('x.com', '/1.1/friendships/destroy.json');
      final body = 'include_profile_interstitial_type=1&include_blocking=1&include_blocked_by=1&include_followed_by=1&include_want_retweets=1&include_mute_edge=1&include_can_dm=1&include_can_media_tag=1&include_ext_is_blue_verified=1&include_ext_verified_type=1&include_ext_profile_image_shape=1&skip_status=1&user_id=$userId';
      ...
      Logger.root.severe('Failed to unfollow user: $e');
      return false;
    }
  }
